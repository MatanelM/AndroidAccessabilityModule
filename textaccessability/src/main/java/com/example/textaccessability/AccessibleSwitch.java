...
public class AccessibleSwitch extends SwitchCompat {

    private static final int[] textSizeArray = new int[]{16, 20, 24};

    public AccessibleSwitch(Context context) {
        super(context);
    }

    public AccessibleSwitch(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public AccessibleSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static void updateAccessibleSwitch(ArrayList<AccessibleSwitch> switches, int type){
        switches.forEach(s -> s.setTextSizeFromType(type));
    }
